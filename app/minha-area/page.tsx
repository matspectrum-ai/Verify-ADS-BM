...
function AccountMenu() {
  ...
  return (
    <div className={styles.accountMenuWrap}>
      <button className={styles.accountButton} onClick={() => setOpen(v => !v)} aria-expanded={open}>
...
function EmptyDomains() {
  return <div className={styles.domainsGrid}>
    <section className={styles.connectCard}>
      ...
      <p>Use seu domínio ou subdomínio (ex: <b>seguro.sualoja.com</b> ou <b>sualoja.com.br</b>) para suas landing pages.</p>
